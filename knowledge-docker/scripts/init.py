...
def initialize(root: Path):
    ...
    client_common = {'enabled':True,'publicClient':True,'standardFlowEnabled':True,'directAccessGrantsEnabled':False,'redirectUris':['http://localhost:18180/auth/callback'],'webOrigins':['http://localhost:18180'],'defaultClientScopes':['profile','email','knowledge:read','knowledge:write','knowledge:feedback'],'protocolMappers':[audience_mapper],'attributes':{'pkce.code.challenge.method':'S256'}}

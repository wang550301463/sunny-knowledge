...
export interface SourceRecord { id: string; space_id: string; name: string; kind: 'git'|'markdown'|'directory'; state: 'active'|'deleted'; version: number; resource_id: string; created_by: string; updated_at: string; url?: string|null; ref?: string|null; path?: string|null; has_credential: boolean; preview?: SourcePreview|null; config: Record<string, unknown>; created_at?: string; latest_task_id?: string|null }
